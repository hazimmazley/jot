      ...
      <div v-else>
        <div class="flex justify-between">
            ...
            <div class=relative>
                ...
                class="px-4 py-2 rounded text-sm font-bold text-green-500 border border-green-500 mr-2"> Edit</router-link>
                ...
                <div v-if="modal" class="absolute bg-blue-900 text-white rounded-lg z-20 p-8 w-64 right-0 mt-2 mr-6">
                    <p>Are youre sure to delete this record?</p>
            ...
            <div v-if="modal" @click="modal = ! modal" class="bg-black opacity-25 absolute right-0 left-0 top-0 bottom-0 z-10">
        ...
        <div class="flex items-center pt-6">
            ...
            <p class="pl-5 text-xk"> {{ contact.name }} </p>
        </div>
